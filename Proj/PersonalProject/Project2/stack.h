...
private:
    ...
    void copy(const Stack<T>& obj);
    // Copies a stack object - used in the copy constructor

    void freeMemory();
    // Frees up memory - used in the destructor and assignment operator
...
// Copies a stack object - used in the copy constructor
template<class T>
void Stack<T>::copy(const Stack &obj){
    Node *cursor;
