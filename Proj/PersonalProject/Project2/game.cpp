...
Game::Game(const unsigned int id, const QString &word, const unsigned int &totalTries,
           const User &p1, const User &p2):gameId(id),codeWord(word),
           maximumTries(totalTries), player1(p1), player2(p2), finished(false){
}
