...
public:
    ...
    T &removeFirst() throw (Empty);
    // Removes and returns the first element in the list

    T &removeLast() throw (Empty);
...
//*************************************************************************
// removeFirst function. Removes and returns the last element in the list *
//*************************************************************************

template<class T>
T& List<T>::removeFirst() throw (Empty){
    if(head){
        ...
        *data = temp->data;
        ...
        // Delete the temp and set tail to the
        // previous link and reduce the size
        delete temp;
        head = head->next;
        --size;
...
//************************************************************************
// removeLast function. Removes and returns the last element in the list *
//************************************************************************
template<class T>
T& List<T>::removeLast() throw (Empty){
    if(tail){               

        // Temporary pointer to tail
        Node *temp = tail;
