...
QT_MOC_LITERAL(1, 5, 9), // "closeGame"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 8), // "openGame"
QT_MOC_LITERAL(4, 25, 11) // "quitClicked"

    },
    "Menu\0closeGame\0\0openGame\0quitClicked"
};
...
void Menu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Menu::closeGame)) {
                *result = 0;
            }
        }
        {
            typedef void (Menu::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Menu::openGame)) {
                *result = 1;
            }
        }
    }
