...
#include "../../gotocell3/gotocelldialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GoToCellDialog_t, stringdata) + ofs \
...
void *GoToCellDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GoToCellDialog.stringdata))
